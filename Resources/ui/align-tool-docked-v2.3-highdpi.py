...
# Form implementation generated from reading ui file '/home/mau/.FreeCAD/Mod/Manipulator-hdpi/Resources/ui/align-tool-docked-v2.3-highdpi.ui'
#
...
class Ui_DockWidget(object):
    def setupUi(self, DockWidget):
        ...
        DockWidget.resize(317, 317)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("/home/mau/.FreeCAD/Mod/Manipulator-hdpi/Resources/ui/Center-Align.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.rbCenters.setMinimumSize(QtCore.QSize(56, 32))
        self.rbCenters.setToolTip("Align Centers")
        self.rbCenters.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("/home/mau/.FreeCAD/Mod/Manipulator-hdpi/Resources/ui/Centers.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rbCenters.setIcon(icon1)
        ...
        self.cbY.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("/home/mau/.FreeCAD/Mod/Manipulator-hdpi/Resources/ui/Yaxis.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.cbY.setIcon(icon2)
        ...
        self.rbPlanesCenters.setMinimumSize(QtCore.QSize(56, 32))
        self.rbPlanesCenters.setToolTip("Align Centers & Planes")
        self.rbPlanesCenters.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("/home/mau/.FreeCAD/Mod/Manipulator-hdpi/Resources/ui/Planes-Centers.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rbPlanesCenters.setIcon(icon3)
        ...
        self.cbZ.setText("")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("/home/mau/.FreeCAD/Mod/Manipulator-hdpi/Resources/ui/Zaxis.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.cbZ.setIcon(icon4)
        ...
        self.cbX.setText("")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("/home/mau/.FreeCAD/Mod/Manipulator-hdpi/Resources/ui/Xaxis.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.rbPlanes.setMinimumSize(QtCore.QSize(56, 32))
        self.rbPlanes.setToolTip("Align Planes")
        self.rbPlanes.setText("")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("/home/mau/.FreeCAD/Mod/Manipulator-hdpi/Resources/ui/Planes.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rbPlanes.setIcon(icon6)
        ...
        self.groupBox = QtWidgets.QGroupBox(self.ReferenceGroup)
        self.groupBox.setTitle("")
        self.groupBox.setObjectName("groupBox")
        self.layoutWidget = QtWidgets.QWidget(self.groupBox)
        self.layoutWidget.setGeometry(QtCore.QRect(0, 8, 120, 34))
        self.layoutWidget.setObjectName("layoutWidget")
        self.gridLayout_3 = QtWidgets.QGridLayout(self.layoutWidget)
        self.gridLayout_3.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.rbMass = QtWidgets.QRadioButton(self.layoutWidget)
        self.rbMass.setMinimumSize(QtCore.QSize(56, 32))
        self.rbMass.setToolTip("Center of\n"
"Mass")
        self.rbMass.setText("")
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("/home/mau/.FreeCAD/Mod/Manipulator-hdpi/Resources/ui/Mass.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rbMass.setIcon(icon7)
        ...
        self.rbBBox = QtWidgets.QRadioButton(self.layoutWidget)
        self.rbBBox.setMinimumSize(QtCore.QSize(56, 32))
        self.rbBBox.setToolTip("Center of\n"
"Boundig Box")
        self.rbBBox.setText("")
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("/home/mau/.FreeCAD/Mod/Manipulator-hdpi/Resources/ui/Bbox.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rbBBox.setIcon(icon8)
        self.rbBBox.setIconSize(QtCore.QSize(26, 26))
        self.rbBBox.setCheckable(True)
        self.rbBBox.setChecked(False)
        self.rbBBox.setObjectName("rbBBox")
        self.gridLayout_3.addWidget(self.rbBBox, 0, 0, 1, 1)
        self.verticalLayout_2.addWidget(self.groupBox)
        self.groupBox_2 = QtWidgets.QGroupBox(self.ReferenceGroup)
        self.groupBox_2.setTitle("")
        self.groupBox_2.setObjectName("groupBox_2")
        self.layoutWidget1 = QtWidgets.QWidget(self.groupBox_2)
        self.layoutWidget1.setGeometry(QtCore.QRect(0, 8, 120, 34))
        self.layoutWidget1.setObjectName("layoutWidget1")
        self.gridLayout = QtWidgets.QGridLayout(self.layoutWidget1)
        self.gridLayout.setContentsMargins(0, 0, 0, 0)
        self.gridLayout.setObjectName("gridLayout")
        self.rbNormal_Inv = QtWidgets.QRadioButton(self.layoutWidget1)
        self.rbNormal_Inv.setMinimumSize(QtCore.QSize(56, 32))
        self.rbNormal_Inv.setToolTip("Alignment Normal\n"
"Inverted")
        self.rbNormal_Inv.setText("")
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("/home/mau/.FreeCAD/Mod/Manipulator-hdpi/Resources/ui/Normal-Down.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.gridLayout.addWidget(self.rbNormal_Inv, 0, 1, 1, 1)
        self.rbNormal = QtWidgets.QRadioButton(self.layoutWidget1)
        self.rbNormal.setMinimumSize(QtCore.QSize(56, 32))
        self.rbNormal.setToolTip("Alignment Normal")
        self.rbNormal.setText("")
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("/home/mau/.FreeCAD/Mod/Manipulator-hdpi/Resources/ui/Normal-Up.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rbNormal.setIcon(icon10)
        self.rbNormal.setIconSize(QtCore.QSize(26, 26))
        self.rbNormal.setChecked(True)
        self.rbNormal.setObjectName("rbNormal")
        self.gridLayout.addWidget(self.rbNormal, 0, 0, 1, 1)
...
"Faces/Planes or Edges/Axis")
        ...
        self.gridLayout_2.addWidget(self.Label_Align_Gui, 0, 9, 1, 1)
        ...
        self.close.setText("")
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("/home/mau/.FreeCAD/Mod/Manipulator-hdpi/Resources/ui/closeW.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.close.setIcon(icon11)
        self.close.setIconSize(QtCore.QSize(24, 24))
        self.close.setObjectName("close")
        self.gridLayout_2.addWidget(self.close, 0, 8, 1, 1)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap("/home/mau/.FreeCAD/Mod/Manipulator-hdpi/Resources/ui/help.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.Help_Align.setIcon(icon12)
        self.Help_Align.setIconSize(QtCore.QSize(24, 24))
        self.Help_Align.setObjectName("Help_Align")
        self.gridLayout_2.addWidget(self.Help_Align, 0, 7, 1, 1)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap("/home/mau/.FreeCAD/Mod/Manipulator-hdpi/Resources/ui/un_dock.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.dock_float.setIcon(icon13)
        self.dock_float.setIconSize(QtCore.QSize(24, 24))
        self.dock_float.setObjectName("dock_float")
        self.gridLayout_2.addWidget(self.dock_float, 0, 2, 1, 1)
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap("/home/mau/.FreeCAD/Mod/Manipulator-hdpi/Resources/ui/xray.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.XRayBtn.setIcon(icon14)
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap("/home/mau/.FreeCAD/Mod/Manipulator-hdpi/Resources/ui/Undo.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.Undo_Align.setIcon(icon15)
        ...
        self.Move.setText("")
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap("/home/mau/.FreeCAD/Mod/Manipulator-hdpi/Resources/ui/Move.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"hierarchy in Aligning")
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap("/home/mau/.FreeCAD/Mod/Manipulator-hdpi/Resources/ui/hierarchy.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.cbHierarchy.setIcon(icon17)
