...
class Ui_DockWidget(object):
    def setupUi(self, DockWidget):
        ...
        self.horizontalLayout_2.addWidget(self.dock_float)
        ...
        self.horizontalLayout_2.addWidget(self.dock_minimize)
...
"Boundig Box")
        ...
        self.gridLayoutWidget_13.setGeometry(QtCore.QRect(8, 80, 134, 36))
        ...
        self.rbNormal = QtGui.QRadioButton(self.gridLayoutWidget_13)
        self.rbNormal.setMinimumSize(QtCore.QSize(64, 32))
        self.rbNormal.setToolTip("Alignment Normal")
        self.rbNormal.setText("")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("Normal-Up.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rbNormal.setIcon(icon6)
        self.rbNormal.setIconSize(QtCore.QSize(26, 26))
        self.rbNormal.setChecked(True)
        self.rbNormal.setObjectName("rbNormal")
        self.gridLayout_15.addWidget(self.rbNormal, 0, 0, 1, 1)
        self.rbNormal_Inv = QtGui.QRadioButton(self.gridLayoutWidget_13)
...
"Inverted")
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("Normal-Down.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rbNormal_Inv.setIcon(icon7)
        ...
        self.gridLayout_15.addWidget(self.rbNormal_Inv, 0, 1, 1, 1)
        ...
        self.cbX = QtGui.QCheckBox(self.gridLayoutWidget_10)
        self.cbX.setMinimumSize(QtCore.QSize(47, 32))
        self.cbX.setMaximumSize(QtCore.QSize(64, 128))
        self.cbX.setToolTip("center on X")
        self.cbX.setText("")
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("Xaxis.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.cbX.setIcon(icon8)
        self.cbX.setIconSize(QtCore.QSize(16, 16))
        self.cbX.setChecked(True)
        self.cbX.setObjectName("cbX")
        self.gridLayout_12.addWidget(self.cbX, 0, 2, 1, 1)
        self.rbCenters = QtGui.QRadioButton(self.gridLayoutWidget_10)
        ...
        self.rbPlanes = QtGui.QRadioButton(self.gridLayoutWidget_10)
        self.rbPlanes.setMinimumSize(QtCore.QSize(64, 32))
        self.rbPlanes.setToolTip("Align Planes")
        self.rbPlanes.setText("")
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("Planes.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rbPlanes.setIcon(icon10)
        ...
        self.rbPlanesCenters = QtGui.QRadioButton(self.gridLayoutWidget_10)
        ...
        self.cbY.setMinimumSize(QtCore.QSize(47, 32))
        self.cbY.setMaximumSize(QtCore.QSize(64, 128))
        self.cbY.setToolTip("center on Y")
        self.cbY.setText("")
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap("Yaxis.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.cbY.setIcon(icon12)
        self.cbY.setIconSize(QtCore.QSize(16, 16))
        self.cbY.setChecked(True)
        self.cbY.setObjectName("cbY")
        self.gridLayout_12.addWidget(self.cbY, 1, 2, 1, 1)
        self.cbZ = QtGui.QCheckBox(self.gridLayoutWidget_10)
        self.cbZ.setMinimumSize(QtCore.QSize(47, 32))
        self.cbZ.setMaximumSize(QtCore.QSize(64, 128))
        self.cbZ.setToolTip("center on Z")
        self.cbZ.setText("")
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap("Zaxis.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.cbZ.setIcon(icon13)
        self.cbZ.setIconSize(QtCore.QSize(16, 16))
        self.cbZ.setChecked(True)
        self.cbZ.setObjectName("cbZ")
        self.gridLayout_12.addWidget(self.cbZ, 2, 2, 1, 1)
...
"Faces/Planes or Edges/Axis")
        ...
        self.gridLayoutWidget_6.setGeometry(QtCore.QRect(4, 16, 213, 46))
        self.gridLayoutWidget_6.setObjectName("gridLayoutWidget_6")
        self.gridLayout_13 = QtGui.QGridLayout(self.gridLayoutWidget_6)
        self.gridLayout_13.setSpacing(2)
        self.gridLayout_13.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_13.setObjectName("gridLayout_13")
        self.Align = QtGui.QPushButton(self.gridLayoutWidget_6)
        self.Align.setMinimumSize(QtCore.QSize(48, 36))
        ...
        self.Help_Align = QtGui.QPushButton(self.gridLayoutWidget_6)
        self.Help_Align.setMinimumSize(QtCore.QSize(48, 36))
        self.Help_Align.setMaximumSize(QtCore.QSize(64, 64))
        self.Help_Align.setText("")
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap("help.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.Help_Align.setIcon(icon14)
        self.Help_Align.setIconSize(QtCore.QSize(24, 24))
        self.Help_Align.setCheckable(False)
        self.Help_Align.setChecked(False)
        self.Help_Align.setObjectName("Help_Align")
        self.gridLayout_13.addWidget(self.Help_Align, 0, 4, 1, 1)
        self.Undo_Align = QtGui.QPushButton(self.gridLayoutWidget_6)
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap("Undo.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.Move = QtGui.QPushButton(self.gridLayoutWidget_6)
        self.Move.setMinimumSize(QtCore.QSize(48, 36))
        self.Move.setMaximumSize(QtCore.QSize(64, 64))
        self.Move.setText("")
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap("Move.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.cbHierarchy.setGeometry(QtCore.QRect(230, 16, 52, 44))
...
"hierarchy in Aligning")
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap("hierarchy.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
